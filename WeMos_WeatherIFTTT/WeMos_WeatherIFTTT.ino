...
void loop() {
  ...
  if(weatherMode==1)
    theaterChase(strip.Color(0, 0, 127), 50); // blue when rain
  else if(weatherMode==2){
    bypass=true;
    theaterChase(strip.Color(127, 127, 127), 50); // White when cloudy
  }else if(weatherMode==3){
    bypass=false;
    rainbowCycle(50);
  }else
    theaterChase(strip.Color(127, 0, 120), 50); // Red
